...
from gatheringData import load_api_keys
from gatheringData import dataset_path

print(f"The dataset_path from DeepLake is ... {dataset_path}")
...
eleven_api_key = api_keys.get('elevenlabs', '')
